...
export const FEATURES = [
  {
    ...
    description: 'Pilih dari puluhan template untuk berbagai momen spesial - Valentine, ulang tahun, wisuda, dan lainnya.',
    color: 'bg-accent-rose',
  },
  {
    icon: Sparkles,
    title: 'Kustomisasi Penuh',
    description: 'Ubah font, warna, layout, dan tambahkan stiker atau foto sesuai keinginanmu.',
    color: 'bg-accent-lavender',
  },
  {
    icon: Mail,
    title: 'Animasi Amplop',
    description: 'Pengalaman membuka surat yang emosional dengan animasi amplop yang smooth dan elegan.',
    color: 'bg-accent-sky',
  },
  {
    icon: Zap,
    title: 'Mudah & Cepat',
    description: 'Buat kartu dalam hitungan menit dengan editor yang intuitif dan real-time preview.',
    color: 'bg-accent-mint',
  },
  {
    icon: Users,
    title: 'Dashboard Personal',
    description: 'Kelola semua kartu yang pernah kamu buat - edit, duplikat, atau bagikan kapan saja.',
    color: 'bg-accent-peach',
  },
  {
    icon: Star,
    title: 'Share Mudah',
    description: 'Bagikan kartu via link unik. Bisa diatur publik atau privat dengan password.',
